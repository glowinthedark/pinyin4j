...
final public class HanyuPinyinOutputFormat {
     ...
     * @return
     */
    public HanyuPinyinOutputFormat restoreDefault() {
     ...
     * @return
     */
    public HanyuPinyinOutputFormat setCaseType(HanyuPinyinCaseType caseType) {
     ...
     * @return
     */
    public HanyuPinyinOutputFormat setToneType(HanyuPinyinToneType toneType) {
     ...
     * @return
     */
    public HanyuPinyinOutputFormat setVCharType(HanyuPinyinVCharType charType) {
        vCharType = charType;
